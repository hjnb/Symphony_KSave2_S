...
Public Class 認定調査票閲覧
    ...
    Private Sub displayUserList()
        ...
        'UsrMデータ取得
        Dim dbConnectPath As String = ""
        If rbtnS.Checked Then
            dbConnectPath = If(topForm.mainType = "S", topForm.DB_KSave2, topForm.DB_AnotherKSave2)
        ElseIf rbtnA.Checked Then
            dbConnectPath = If(topForm.mainType = "A", topForm.DB_KSave2, topForm.DB_AnotherKSave2)
        End If
        cnn.Open(dbConnectPath)
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub rbtn_CheckedChanged(sender As Object, e As System.EventArgs) Handles rbtnS.CheckedChanged, rbtnA.CheckedChanged
